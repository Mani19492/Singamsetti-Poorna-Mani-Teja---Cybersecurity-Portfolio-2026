...
$("#contactform").on("submit", function(e) {
	var a = $("#name").val(),
		...
		t = $("#subject").val(),
		o = $("#message").val();
	("" === a && $("#name").addClass("error-color"), "" === s && $("#email").addClass("error-color"), "" === t && $("#subject").addClass("error-color"), "" === o) ? $("#message").addClass("error-color"): ($.ajax({
